...
// Every script below is env-gated: with no keys set, this component renders
// nothing and adds zero overhead. Add the relevant NEXT_PUBLIC_* var in
// .env.local (see README) to switch each one on.
